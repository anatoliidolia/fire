    ...
    public function job($output, $additionalOptions = null)
    {
        ...
        $sourceSelect = $source->select()
            ->from('core_url_rewrite', [
                'entity_type' => new \Zend_Db_Expr("IF(product_id, 'product', IF(category_id, 'category', null))"),
                'entity_id' => new \Zend_Db_Expr('IF(product_id, product_id, IF(category_id, category_id, null))'),
